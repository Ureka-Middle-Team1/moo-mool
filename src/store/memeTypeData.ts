...
끝나지 않는 재미가 기다리고 있어요.`,
    ...
    shortDescription: '"오늘도 넷플릭스와 유튜브가 날 부른다!"',
  },
  SNS: {
...
SNS 없인 못 살아~`,
    ...
    shortDescription: '"좋아요 놀러줘~💓 필터는 진심이야!"',
  },
  Saving: {
...
지갑이 가벼워도 머리는 무거운 당신, 바로 무너계의 '알뜰킹 천재'!`,
    ...
    shortDescription: '"쓸 땐 쓰더라고, 아낄 땐 확실하게!"',
  },
  Chat: {
...
'문자요정 무너'!`,
    ...
    shortDescription: '"전화는 부담스러워... 톡은 언제든 환영!"',
  },
  Calling: {
...
감정까지 실시간 전송하는 '수다본능' 전화파 무너.목소리로 세상을 연결해요!`,
    ...
    shortDescription: '"톡 말고 전화해! 목소리가 국룰이야~"',
  },
  Books: {
...
당신은 늘 '왜?'라는 물음을 던지며 지식의 바다를 헤엄치는 탐험가!`,
    ...
    shortDescription: '"모르는 건 못 참아~ 바로 검색 각!"',
  },
} as const;
