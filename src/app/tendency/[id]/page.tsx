...
export default function PlanDetailPage() {
  ...
  return (
    <main className="flex flex-col items-center space-y-8 bg-[#fff6d8] min-h-screen">

      <section className="w-full max-w-md">
        
        <div className="w-full flex items-center gap-23 mb-3 bg-[#ffffff]">
      ...
      <div className="px-8">
        <h1 className="text-[28px] font-bold text-gray-900 leading-tight mt-[20px]">
          {planName}
        </h1>
        ...
        <div className="flex flex-wrap gap-1 my-1 mb-[20px]">
          {tags.map((tag, index) => (
            <span
              key={index}
              className={`px-1 py-1 rounded-md text-[10px] font-medium
        ...
        <div className="flex space-x-2 bg-gray-400 p-1 rounded-lg shadow-sm mb-4">
          <button className="flex-1 py-1 rounded-lg bg-white text-black font-semibold text-sm">
            기본
          </button>
          <button className="flex-1 py-1 rounded-lg text-black text-sm hover:text-gray-700">
            내 요금제와 비교
          </button>
        </div>
